...
\centering
\img[height=3cm]{August-Hoegn_Wanderjahre}
\caption{August Högn}
\end{subfigure}
%
\begin{subfigure}[b]{0.3\linewidth}
\centering
\img[height=3cm]{Emma-Hoegn}
\caption{Emma Högn}
\end{subfigure}
%
\begin{subfigure}[b]{0.3\linewidth}
\centering
\img[height=3cm]{Hochzeitseinladung-und-Menue}
...
\img[width=0.3\textwidth]{Gustl-und-Frieda-Hoegn}

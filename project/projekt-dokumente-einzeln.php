...
$result  =  mysql_query('SELECT * FROM dokumente WHERE id=' . $_GET['id']);
...
echo "<p>\n";
if (!empty ($row[datum]))echo "<strong>Datum:</strong> " . datum ($row, 0) . "<br>\n";
if (!empty ($row[thematik]))echo "<strong>Thematik:</strong> " . dokumente_thematiktext ($row) . "<br>\n";

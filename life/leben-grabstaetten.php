...
?>
                        <table >
                          <tr>
                            <td><a href="images/leben-grabstaetten/grab_gross.jpg"><img src="images/leben-grabstaetten/grab_klein.jpg" /></a></td>
                            <td>
                              <p> Familiengrab von Ludwig H&ouml;gn (links) und ehemalige Grabst&auml;tte von August H&ouml;gn und seiner Ehefrau (rechts), heute im Besitz der Familie Nirschl im Deggendorfer Friedhof.</p></td>
                          </tr>
                          <tr> 
                            <td><a href="images/leben-grabstaetten/totenbrett_gross.jpg"><img src="images/leben-grabstaetten/totenbrett_klein.jpg" /></a></td>
                            <td>
								<p>Totenbrett von August H&ouml;gn im Osterbr&uuml;nnl, das einzige Denkmal das 
                                in Ruhmannsfelden noch an August H&ouml;gn erinnert. 
                                Das Grab in Deggendorf wurde aufgel&ouml;st.</p></td>
                          </tr>
                          <tr> 
                            <td><a href="images/leben-grabstaetten/august_hoegn_jun_gross.jpg"><img src="images/leben-grabstaetten/august_hoegn_jun_klein.jpg" /></a></td>
                            <td>
<p>Das Grab von August H&ouml;gn junior am Ruhmannsfeldener Friedhof. Er konnte 
                                wahrscheinlich nicht im Familiengrab in Deggendorf 
                                eingegraben werden, weil es zu dieser Zeit schon 
                                aufgel&ouml;st war. </p></td>
                          </tr>
                        </table>
            <!-- InstanceEndEditable --> </div>
        <!-- IE Column Clearing -->

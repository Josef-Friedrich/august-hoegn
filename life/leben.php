...
$tm->RubricLink ("leben-biographie");
$tm->RubricLink ("leben-lebenslauf");

$tm->RubricHeadline ("Fotos mit August H&ouml;gn");

$tm->RubricLink ("leben-hoegn-portrait");
$tm->RubricLink ("leben-hoegn-gruppen");
$tm->RubricLink ("leben-verwandte-bekannte");

$tm->RubricHeadline ("Fotos aus der Zeit von August H&ouml;gn");

$tm->RubricLink ("leben-ruhmannsfelden-hoegn");
$tm->RubricLink ("leben-pfarrkirche-hoegn");
$tm->RubricLink ("leben-volksschule-hoegn");

$tm->RubricHeadline ("Fotos aus der heutigen Zeit");

$tm->RubricLink ("leben-grabstaetten");

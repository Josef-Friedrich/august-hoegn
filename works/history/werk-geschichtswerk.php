    ...
    <div id="header">
      <div class="subcolumns">
        ...
        <div id="header_col3"> <!-- InstanceBeginEditable name="metaphernfenster" -->
              <div id="metaphor_geschichtswerk" class="metaphor">
                <div class="image"></div>
                <div class="gradient"></div>
                <div class="text">Geschichtswerk</div>
...
?>
                        <table border="0" cellspacing="0" cellpadding="5">
                          <tr valign="top"> 
                            <td><a href="werk-geschichtswerk-ruhmannsfelden.php"><img src="files/geschichtswerk/index/ruhmannsfelden.jpg" width="100" height="129" border="0" /></a></td>
                            <td><p><a href="werk-geschichtswerk-ruhmannsfelden.php">Geschichte 
                                von Ruhmannsfelden</a>&nbsp;</p>                            </td>
                          </tr>
                          <tr valign="top"> 
                            <td><a href="werk-geschichtswerk-zachenberg.php"><img src="files/geschichtswerk/index/zachenberg.jpg" width="100" height="135" border="0" /></a></td>
                            <td><p><a href="werk-geschichtswerk-zachenberg.php">Geschichte 
                                von Zachenberg (H&ouml;gn/Trellinger)</a></p>                            </td>
                          </tr>
                          <tr valign="top"> 
                            <td><a href="werk-geschichtswerk-feuerwehr.php"><img src="files/geschichtswerk/index/feuerwehr.jpg" width="100" height="134" border="0" /></a></td>
                            <td><p><a href="werk-geschichtswerk-feuerwehr.php">Geschichte 
                                der Feuerwehr Ruhmannsfelden</a></p>                            </td>
                          </tr>
                          <tr valign="top"> 
                            <td><a href="werk-geschichtswerk-zeitung.php"><img src="files/geschichtswerk/index/zeitung.jpg" width="100" height="134" border="0" /></a></td>
                            <td><p><a href="werk-geschichtswerk-zeitung.php">Heimatkundliche 
                                Zeitungsartikel</a></p>                            </td>
                          </tr>
                        </table>
            <!-- InstanceEndEditable --> </div>
        <!-- IE Column Clearing -->

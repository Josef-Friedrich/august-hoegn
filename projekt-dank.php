...
?>
          <p><img src="images/projekt-dank/dank.jpg" width="200" height="145" /> </p>
          <?php
						
	$result  =  mysql_query("SELECT * FROM dank ORDER BY nachname, vorname");
	echo "<table><tr>";
	while ($row  =  mysql_fetch_array($result))	{
		echo "<tr><td><strong>$row[nachname], $row[vorname]</strong></td>";
		echo "<td>$row[dank_fuer]</td></tr>";
		}
		echo "</table>";
		
						
?>
          <p>... und auch Dank an alle, die in dieser Liste vergessen wurden.</p>
          <!-- InstanceEndEditable --> </div>
        <!-- IE Column Clearing -->

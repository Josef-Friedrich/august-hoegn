...
$tm->RubricHeadline ("Ver&ouml;ffentlichungen");

$tm->RubricLink ("projekt-buch");
$tm->RubricLink ("projekt-buch-praesentation");
$tm->RubricLink ("projekt-noten");

$tm->RubricHeadline ("Forschung");

$tm->RubricLink ("projekt-dokumente");
$tm->RubricLink ("projekt-interviews");

$tm->RubricHeadline ("Hintergrundinformationen");

$tm->RubricLink ("projekt-wiederauffuehrungen");
$tm->RubricLink ("projekt-auffuehrungsmaterial");
$tm->RubricLink ("projekt-geschichtswerk-papier");
$tm->RubricLink ("projekt-kopien-handschriften");
$tm->RubricLink ("projekt-dank");
?>
            <!-- InstanceEndEditable --> </div>
        <!-- IE Column Clearing -->

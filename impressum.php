...
?>
                        <p>Josef Friedrich jun.<br>
                          Schulstra&szlig;e 53<br>
                          94239 Ruhmannsfelden</p>
                        <p>E-Mail: <a href="mailto: Jos.Friedrich@googlemail.com"> Jos.Friedrich@googlemail.com</a><br>
                          Internet: <a href="http://www.august-hoegn.de">www.august-hoegn.de</a> 
                          oder <a href="http://august-hoegn.woidwideweb.de">august-hoegn.woidwideweb.de</a><br>
                          Inhaltlich Verantwortlicher gem&auml;&szlig; &sect; 
                          10 Absatz 3 MDStV: Josef Friedrich jun. (Anschrift wie 
                          oben)</p>
                        <p>Haftungshinweis: Trotz sorgf&auml;ltiger inhaltlicher 
                          Kontrolle &uuml;bernehmen wir keine Haftung f&uuml;r 
                          die Inhalte externer Links. F&uuml;r den Inhalt der 
                          verlinkten Seiten sind ausschlie&szlig;lich deren Betreiber 
                          verantwortlich.</p>
                        <h1>Einverst&auml;ndniserkl&auml;rung</h1>
                        <p>Die Enkelin von August H&ouml;gn Gertraud von Molo gab am 16.12.2004 Josef Friedrich das Nutzungsrecht am Gesamtwerk von August H&ouml;gn:</p>                        <p><a href="images/impressum/einverstaendniserklaerung_gross.gif"><img src="images/impressum/einverstaendniserklaerung_klein.gif" width="300" height="225" border="0" /></a></p>
            <!-- InstanceEndEditable --> </div>
        <!-- IE Column Clearing -->

...
?>
          <p>Um die zu Teil doch recht stark abgenutzten Autographen
            der Kompostitionen von H&ouml;gn zu schonen und um
            bei  Editionsarbeiten handlicheren Notentext als Vorlage
            verwenden zu k&ouml;nnen, wurden Kopien aller Handschrifen
            angefertigt und diese dann  gebunden. Mittlerweile
            gibt es schon 5 Faksimile-B&auml;nde dieser Art.
            Nach  Abschluss des Projekts &quot;August H&ouml;gn
            - Leben  und Werk&quot; werden diese B&auml;nde
            dann an Bibliotheken  oder anderen freizug&auml;nglichen
            Archiven weitergeleitet.</p>
          <table class="scan-table">
            <tr>
              <td><a href="images/projekt-kopien-handschriften/stapel_gross.jpg"><img src="images/projekt-kopien-handschriften/stapel_klein.jpg" width="200" height="150" border="0" /></a></td>
              <td><a href="images/projekt-kopien-handschriften/drei_und_zwei_gross.jpg"><img src="images/projekt-kopien-handschriften/drei_und_zwei_klein.jpg" width="171" height="150" border="0" /></a></td>
            </tr>
            <tr>
              <td><a href="images/projekt-kopien-handschriften/reihe_gross.jpg"><img src="images/projekt-kopien-handschriften/reihe_klein.jpg" width="200" height="119" border="0" /></a></td>
              <td>&nbsp;</td>
            </tr>
          </table>
          <!-- InstanceEndEditable --> </div>

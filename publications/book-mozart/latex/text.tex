...
\usepackage{color}
\usepackage[top=2.9cm,bottom=8.401cm,left=4.6cm,right=4.6cm,nohead,includefoot,foot=0.85cm,footskip=1.6010001cm]{geometry}
\usepackage{array}
\usepackage{hhline}
\usepackage{hyperref}
...
\begin{document}
\clearpage\setcounter{page}{3}{\centering
Josef Friedrich
\par}
...
\title{Kindheit in Deggendorf}
\begin{document}
\clearpage\setcounter{page}{9}\section{Kindheit in Deggendorf}
...
\subsection{Ausbildung zum Lehrer und zum Musiker}
...
einem \textstyleZitate{tüchtigen Schullehrer} oder einem
\textstyleZitate{vorzüglichen Geistlichen }eine Art Lehre oder
...
unterteilt in die Teilbereiche \textstyleZitate{Gesang, Violine,
Klavier, Orgel }und\textstyleZitate{ Harmonielehre }– hatte innerhalb
...
des \textstyleZitate{gebundenen Spiels.} Die Schüler sollten in der
...
Ehrenbür\-gerrecht \textstyleZitate{aus Anlass seines 25-jährigen
Dienstjubiläums }und \textstyleZitate{für die großen Verdienste, die er
...
\textstyleZitate{großes Orchester aus lauter Ruhmannsfeldener Musikern
...
vorwurfsvoll: \textstyleZitate{\textup{„Kriegt sie heute kein Bier?“}
...
\textstyleZitate{Der Högn war ein selten guter Musiker. So einer steht
nicht mehr auf.}

\textstyleZitate{\textup{Zur größten Zufriedenheit der ganzen
...
\textstyleZitate{einen guten Namen hatte }und unter der Leitung von
Anna Auer \textstyleZitate{einen Niedergang }erlebte, bei Högn wieder
eine \textstyleZitate{Verbesserung erfuhr\textup{.}}
...
gewesen, und behauptete, dass eine Zurechtweisung \textstyleZitate{zur
Zeit von Lehrer Högn }passend gewesen wäre, als \textstyleZitate{nicht
...
verzichte und in der \textstyleZitate{Kirchenratssitzung Abbitte
...
\textstyleZitate{zur Übernahme des Kirchenchores notwen\-digen
musikalischen Fähigkeiten und Kenntnisse }und daher solle die
zuständige Be\-hörde den Chorregentendienst von Högn
\textstyleZitate{bis auf weiteres }genehmigen. Högn kannte Fahrmeier
...
\subsection{Ernennung zum Oberlehrer}
...
sich so die \textstyleZitate{Lungen besser weiten }könnten. Den
...
\clearpage\subsection{Chorregent in schwieriger Zeit}
...
der Schluss des Textes in Erinnerung: \textstyleZitate{Ein Geist
\textup{[}}NS]\textstyleZitate{ lässt Deutschland neu erstehn.}
...
Betreff \textstyleZitate{Anlegung gemeindlicher Ortsgeschichten} macht
...
allem \textstyleZitate{die Herren Lehrer [...] sollten“
}daher\textstyleZitate{ „ohne weiteres Säumen und mit allem Nach\-druck
...
hatten, zeigt schon die Aufforderung, dass \textstyleZitate{bis zum 1.
...
\textstyleZitate{in dankbarer Erinnerung} der Feuerwehr gewidmete
...
Zachenberg zu ernennen und ihm als \textstyleZitate{Ent\-schädigung
}für seine Bemühungen ein \textstyleZitate{Geldgeschenk im Ermessen des
...
\textstyleZitate{klangvollen Chor} unter der Leitung des Kompo\-nisten
den \textstyleZitate{ergreifenden} Vortrag der \textstyleZitate{Missa
St. Josephi.}
...
\textstyleZitate{romantisch, liebenswerter Kompositionsstil }gelobt.
Weiter heißt es: \textstyleZitate{Das Benediktus für Sopransolo und
...
Ausleihen des Notenmaterials und versicherte ihm: \textstyleZitate{Sie
hat am Josephsfest gut gefallen. Ich habe verschiedene Stimmen darüber
gehört. Unser }\textstyleZitate{geistlicher Rat hier hat sich sehr
...
Messe\textstyleZitate{ verrät gediegene Hand\-werkskunst, die sich in
...
\clearpage\subsection{Unwürdiger Abschied als Chorregent}
...
\textstyleZitate{klangvollen Chor} zu Reicheneders Installation war
...
der \textstyleZitate{berechtigten Forderung auf Ruhestand auch im
...
Högns \textstyleZitate{Standpunkt voll und ganz verstehen} könne,
seinen Rücktritt aber \textstyleZitate{sehr bedauere.}
...
\textstyleZitate{Kündigung seitens des Hochwürdigen Herrn Pfarrers und
der gleichen} als \textstyleZitate{blödes Weibergeschwätz} bewertet und
darauf hinweist, dass \textstyleZitate{eine vertrag\-liche Abmachung
über den Kirchenchordienst zwischen Pfarramt Ruhmannsfelden }und ihm
\textit{niemals bestanden} habe.\textstyleZitate{\textup{ }}Und seine
angebliche \textstyleZitate{Stimmbandlähmung, }die Rei\-cheneder als
...
\textstyleZitate{Leistungsabzeichen für nächtliche Liebesfahrten}
...
\textstyleZitate{Bis die Haupträdelsführer beim Pfarramt vorstellig
...
beklagt sich, dass sein \textstyleZitate{gesundheitliches Befinden
nicht das beste} ist und das \textstyleZitate{Marschie\-ren sehr
...
zur \textstyleZitate{Kran\-kenfürsorgerin.}
...
\textstyleZitate{\textup{kürzere Krankheit} }zurückzuführen gewesen
sein, als auf eine \textstyleZitate{lange schwere} Krankheit, wie es im
...
\subsubsection{Geistliche Musik}
\begin{flushleft}
\tablefirsthead{}
\tablehead{}
\tabletail{}
...
\end{supertabular}
\end{flushleft}
\clearpage\subsubsection{Geschichtswerk}
...
\subsection{Interviews mit Zeitzeugen von Högn}
...
\subsubsection{Quellen aus Archiven}
Reicheneder-Chronik:
